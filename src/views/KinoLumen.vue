<template>
  ...
  <section class="gs-container gs-container_center">
    <ol class="gs-breadcrumb">
      ...
      <li class="gs-breadcrumb__list-item gs-breadcrumb__list-item_active"> Кино «Люмен Фильм» </li>
    </ol>
  </section>
